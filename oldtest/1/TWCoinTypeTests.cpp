...
TEST(TWWestendCoinType, TWCoinType) {
    ...
    auto accId = WRAPS(TWStringCreateWithUTF8Bytes("5FqqU2rytGPhcwQosKRtW1E3ha6BJKAjHgtcodh71dSyXhoZ"));
    ...
    assertStringsEqual(accUrl, "https://westend.subscan.io/account/5FqqU2rytGPhcwQosKRtW1E3ha6BJKAjHgtcodh71dSyXhoZ");
